...
const ScrollIndicator = ({ show, hide, color, ...props }) => (
  <svg
    className={classnames(
      styles.srollIndicator,
      show ? styles.show : '',
      hide ? styles.hide : ''
    )}
    {...props}
  ...
  >
    <g fill="none" fillRule="evenodd">
      <path
        className={classnames(styles.arrow, styles['arrow-2'])}
        fill={colors[color]}
      ...
      />
      <path
        className={classnames(styles.arrow, styles['arrow-1'])}
        fill={colors[color]}
